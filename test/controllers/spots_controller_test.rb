...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { left: @spot.left, top: @spot.top, world_id: @spot.world_id } }, as: :json
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { left: @spot.left, top: @spot.top, world_id: @spot.world_id } }, as: :json
    assert_response 200
  end
